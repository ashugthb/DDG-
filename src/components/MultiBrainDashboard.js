// MultiBrainDashboard.js - Updated with proper new tab functionality and enhanced color scheme
...
// Memoized InfoPanel component to prevent unnecessary re-renders
  ...
  return (
    <AppContainer ref={containerRef} sx={{ position: "relative" }}>
      ...
      >
        ...
        {/* Info Panel - Using memoized version */}
        <MemoizedInfoPanel
